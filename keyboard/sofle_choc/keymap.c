...
[_BASE] = LAYOUT(
    ...
    KC_LCTL,  KC_A,  KC_S,   KC_D,     KC_F,     KC_G,                            KC_H,        KC_J,     KC_K,     KC_L,    KC_BSPC,   KC_NO,
...
[_LOWER] = LAYOUT(
    ...
    KC_CIRC,  KC_1,   KC_2,   KC_3,   KC_4,   KC_5,                  KC_6,     KC_7,     KC_8,   KC_9,     KC_0,    DE_ACUT,
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    [_BASE] = {
        ENCODER_CCW_CW(KC_VOLU, KC_VOLD), // left  rot encoder
        ENCODER_CCW_CW(KC_MNXT, KC_MPRV), // right rot encoder
    },
    [_LOWER] = {
        ENCODER_CCW_CW(KC_VOLU, KC_VOLD), // left  rot encoder
        ENCODER_CCW_CW(KC_MNXT, KC_MPRV), // right rot encoder
