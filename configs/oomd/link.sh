...
# scope oomd's kill authority to app.slice only, Hyprland itself stays ineligible systemd ships no oomd.conf.d by default, so the drop-in dir has to be created.
