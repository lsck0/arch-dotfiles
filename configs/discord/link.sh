...
# download plugins
wget "https://mwittrien.github.io/BetterDiscordAddons/Library/0BDFDB.plugin.js" -O ${HOME}/.config/BetterDiscord/plugins/0BDFDB.plugin.js
wget "https://mwittrien.github.io/BetterDiscordAddons/Plugins/LastMessageDate/LastMessageDate.plugin.js" -O ${HOME}/.config/BetterDiscord/plugins/LastMessageDate.plugin.js
