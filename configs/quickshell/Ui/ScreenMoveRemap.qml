...
Item {
  ...
  // Hold the surface unmapped for a beat so the compositor processes the unmap before the remap instead of coalescing them into a no-op.
  Timer {
    interval: 50
